      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center min-h-[100vh]">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <div className="flex justify-center">
            <Link href={"/auth/login"} className="inline-flex text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded text-lg" >Get Started</Link>
        ...
        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
          <Image className="object-cover object-center rounded" width={700} height={500} alt="hero" src="https://dummyimage.com/720x600"/>
        </div>
      </div>
    </section>
  );
